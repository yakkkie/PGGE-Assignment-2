...
public class ShrekPlayer : MonoBehaviour
{
    [HideInInspector]
    ...
    public int mMaxAtacksBeforeRecharge = 5;
    ...
    //[HideInInspector]
    public int mAttacksRemaining = 5;
    ...
    void Start()
    {
        mFsm.Add(new ShrekPlayerState_MOVEMENT(this));
        mFsm.Add(new ShrekPlayerState_ATTACK(this));
        mFsm.Add(new ShrekPlayerState_RECHARGE(this));
